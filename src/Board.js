 ...
 */
    ...
    // conflict = a row that contains more than one '1' 
    // input - row index
    // output - boolean, true if there is a conflict and false if no conflict
    ...
    // input - a column from playing board
    // output boolean true if conflict, false if not
    ...
    // input is a value from -n.lenght to n.length
